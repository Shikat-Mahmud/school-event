...
<body>
            ...
            <div class="auth-content">
                ...
                <div class="card">
                    <div class="card-body text-center">
                        ...
                        <p class="mb-0 text-muted">Allready have an account? <a href="{{ route('login') }}"> Log in</a>
                        </p>
                    </div>
                </div>
            </div>
    ...
    <script src="{{ asset('/assets/plugins/bootstrap/js/bootstrap.min.js') }}"
        type="ac266612bdc379950ac657-text/javascript"></script>
    <script src="{{ asset('/assets/js/menu-setting.min.js') }}"
        type="ac2db66612bdc379950ac657-text/javascript"></script>
    <script src="{{ asset('/assets/js/pcoded.min.js') }}" type="ac2db66612bdc379950ac657-text/javascript"></script>
    <script src="{{ asset('/assets/plugins/amchart/js/amcharts.js') }}"
        type="ac2db66612bdc379950ac657-text/javascript"></script>
    <script src="{{ asset('/assets/plugins/amchart/js/gauge.js') }}"
        type="ac2db66612bdc379950ac657-text/javascript"></script>
    <script src="{{ asset('/assets/plugins/amchart/js/serial.js') }}"
        type="ac2db66612bdc379950ac657-text/javascript"></script>
    <script src="{{ asset('/assets/plugins/amchart/js/light.js') }}"
        type="ac2db66612bdc379950ac657-text/javascript"></script>
    <script src="{{ asset('/assets/plugins/amchart/js/pie.min.js') }}"
        type="ac2db66612bdc379950ac657-text/javascript"></script>
    <script src="{{ asset('/assets/plugins/amchart/js/ammap.min.js') }}"
        type="ac2db66612bdc379950ac657-text/javascript"></script>
    <script src="{{ asset('/assets/plugins/amchart/js/usaLow.js') }}"
        type="ac2db66612bdc379950ac657-text/javascript"></script>
    <script src="{{ asset('/assets/plugins/amchart/js/radar.js') }}"
        type="ac2db66612bdc379950ac657-text/javascript"></script>
    <script src="{{ asset('/assets/plugins/amchart/js/worldLow.js') }}"
        type="ac2db66612bdc379950ac657-text/javascript"></script>

    <script src="{{ asset('/assets/plugins/notification/js/bootstrap-growl.min.js') }}"
        type="ac2db66612bdc379950ac657-text/javascript"></script>

    <script src="{{ asset('/assets/js/pages/dashboard-custom.js') }}"
        type="ac2db66612bdc379950ac657-text/javascript"></script>
    <script src="../../../../../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js"
        data-cf-settings="ac2db66612bdc379950ac657-|49" defer></script>
