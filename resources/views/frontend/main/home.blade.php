...
@section('content')
            ...
            <div class="et-banner-slider swiper">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="bg-no-repeat bg-cover bg-[url('{{asset('/')}}frontend/img/banner-2-bg-1.jpg')] bg-center pt-[clamp(140px,12.7vw,213px)] text-white relative overflow-hidden z-[1] before:content-normal before:absolute before:inset-0 before:bg-gradient-to-r before:from-[#1900B1] before:from-50% before:to-transparent before:-z-[1] before:opacity-50">
                            <div class="mx-[15.5em] xxxl:mx-[10em] xxl:mx-[40px] xs:mx-[12px] mb-[132px] xl:mb-[112px] lg:mb-[82px]">
                                <div class="flex md:flex-col items-center justify-between gap-x-[30px] gap-y-[30px] md:grid-cols-1">
                                    <div class="left relative z-[20] w-[80%] md:w-full">
                                        <h6 class="font-kalam font-bold text-[2.4rem] mb-[3px] anim-text">Personal Event 2024</h6>

                                        <h1 class="text-[clamp(42px,6.25vw,12rem)] font-semibold leading-[1.1] mb-[36px] md:mb-[36px] anim-text">Ex Students <span class="italic font-normal">Child Care Academy</span></h1>
                            ...
                            <div class="flex gap-[120px] xxxl:gap-[60px] xl:gap-[40px] lg:flex-col-reverse items-center">
                                <div class="max-w-[1170px] bg-etBlue relative z-[1] p-[60px] sm:p-[40px] xs:px-[20px] rounded-tr-[20px] lg:rounded-none overflow-hidden shadow-[0_4px_50px_rgba(18,96,254,0.2)] after:absolute after:inset-0 after:-z-[1] after:bg-[url(../assets/img/et-counter-bg.jpg)] after:bg-cover after:bg-no-repeat after:mix-blend-screen flex xxl:flex-col items-center xxl:items-start md:flex-wrap gap-y-[20px]">
                                    ...
                                    <!-- vectors -->
                                    <div class="sm:hidden">
                                        <img src="{{asset('/')}}frontend/img/counter-vector.png" alt="vector" class="pointer-events-none absolute top-[26px] left-[53%]">
                                        <img src="{{asset('/')}}frontend/img/counter-vector.png" alt="vector" class="pointer-events-none absolute bottom-[33px] right-[90px]">
                                    </div>
                                </div>
                            ...
                            <div class="et-banner-vectors">
                                <div class="absolute left-[26px] top-[235px]"><img src="{{asset('/')}}frontend/img/team-vector.png" alt="vector" class="w-[50px] !animate-none !rotate-0 md:hidden"></div>
                                <div class="absolute bottom-[352px] left-[845px]"><img src="{{asset('/')}}frontend/img/banner-vector.png" alt="vector"></div>
                                <div class="absolute top-[214px] right-[190px]"><img src="{{asset('/')}}frontend/img/banner-vector-2.png" alt="vector" class="w-[21px] h-[21px]"></div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container mx-auto max-w-[calc(100%-39.1vw)] xxxl:max-w-[calc(100%-350px)] xl:max-w-[calc(100%-170px)] px-[12px] lg:max-w-full">
                <div class="flex items-center md:flex-wrap gap-x-[60px] xl:gap-x-[40px] lg:gap-x-[30px] gap-y-[40px] sm:gap-y-[40px] lg:justify-center">
                    ...
                    <div class="et-about-img relative z-[1] md:w-auto shrink-0 max-w-full ml-[124px] md:mr-0 xs:mx-auto">
                        ...
                        <img src="{{asset('/')}}frontend/img/about-2-img-2.jpg" alt="image" class="et-about-floating-img absolute top-[55px] -left-[124px] shrink-0 rounded-[20px] border-white border-[10px] shadow-[0_4px_40px_0_rgba(0,0,0,0.1)] xs:hidden" />

                        <!-- vectors -->
                        <div class="et-about-vectors">
                            <img src="{{asset('/')}}frontend/img/about-img-vector-4.png" alt="vector" class="et-about-vector-1 absolute -left-[98px] top-[20px] -z-[1] xxs:hidden" />
                            <img src="{{asset('/')}}frontend/img/team-vector.png" alt="vector" class="et-about-vector-2 w-[50px] absolute -left-[70px] bottom-[115px] -z-[1] !animate-none" />
                        </div>
                    </div>
                        ...
                        <div class="flex flex-wrap items-center gap-x-[30px] gap-y-[16px] rev-slide-up">
                            ...
                            <div class="flex items-center gap-[10px]">
                                <div class="flex *:-ml-[20px]">
                                    <img src="{{asset('/')}}frontend/img/reviewer-1.png" alt="Person" class="w-[60px] h-[60px] rounded-full border-[3px] border-white first:ml-0">
                                    <img src="{{asset('/')}}frontend/img/reviewer-2.png" alt="Person" class="w-[60px] h-[60px] rounded-full border-[3px] border-white first:ml-0">
                                    <img src="{{asset('/')}}frontend/img/reviewer-3.png" alt="Person" class="w-[60px] h-[60px] rounded-full border-[3px] border-white first:ml-0">
        ...
        <section class="et-2-schedules bg-[#EEF4FF] bg-[url('{{asset('/')}}frontend/img/schedule-bg.png')] bg-cover bg-no-repeat bg-center relative py-[130px] xl:py-[80px] md:py-[60px] before:absolute before:inset-0 before:bg-[url('../assets/img/')]">
                    ...
                    <div id="tab1" class="et-tab active">
                        <div class="all-scheduled-events flex flex-col gap-[30px]">
                            ...
                            <div class="et-2-schedule bg-white mt-[57px] p-[12px] pt-0 rounded-[20px] inline-flex md:flex-col w-full gap-y-[20px] justify-between relative z-[2] rev-slide-up">
                                ...
                                <div class="w-[240px] shrink-0 relative">
                                    <div class="et-2-schedule-img absolute md:static md:-mt-[45px] bottom-0 md:before:content-none before:absolute before:top-0 before:left-[100%] before:w-full before:h-full before:bg-gradient-to-br before:from-etBlue before:to-[#0B3998] before:-z-[1]">
                                        <img src="{{asset('/')}}frontend/img/evenet-sched-1.jpg" alt="scehduled-event-cover" class="rounded-[20px] rounded-tr-none object-cover aspect-[8/9]">
                                    </div>
                                </div>
                                ...
                                <div class="px-[30px] sm:px-[12px] py-[25px] sm:pb-[15px] pt-[37px] md:pt-0 w-full flex xs:flex-col gap-y-[15px] items-center bg-white">
                                    ...
                                    <div class="flex shrink-0 xxl:flex-col xs:flex-row flex-wrap items-center xxl:items-start xs:items-center gap-x-[54px] gap-y-[16px]">
                                        <div class="flex items-center">
                                            <div class="flex *:-ml-[20px]">
                                                <img src="{{asset('/')}}frontend/img/reviewer-1.png" alt="Person" class="w-[45px] h-[45px] rounded-full border-[3px] border-white first:ml-0">
                                                <img src="{{asset('/')}}frontend/img/reviewer-2.png" alt="Person" class="w-[45px] h-[45px] rounded-full border-[3px] border-white first:ml-0">
                                                <img src="{{asset('/')}}frontend/img/reviewer-3.png" alt="Person" class="w-[45px] h-[45px] rounded-full border-[3px] border-white first:ml-0">
                            ...
                            <div class="et-2-schedule bg-white mt-[57px] p-[12px] pt-0 rounded-[20px] inline-flex md:flex-col w-full gap-y-[20px] justify-between relative z-[2] rev-slide-up">
                                ...
                                <div class="w-[240px] shrink-0 relative">
                                    <div class="et-2-schedule-img absolute md:static md:-mt-[45px] bottom-0 md:before:content-none before:absolute before:top-0 before:left-[100%] before:w-full before:h-full before:bg-gradient-to-br before:from-etBlue before:to-[#0B3998] before:-z-[1]">
                                        <img src="{{asset('/')}}frontend/img/evenet-sched-2.jpg" alt="scehduled-event-cover" class="rounded-[20px] rounded-tr-none object-cover aspect-[8/9]">
                                    </div>
                                </div>
                            ...
                            <div class="et-2-schedule bg-white mt-[57px] p-[12px] pt-0 rounded-[20px] inline-flex md:flex-col w-full gap-y-[20px] justify-between relative z-[2] rev-slide-up">
                                ...
                                <div class="w-[240px] shrink-0 relative">
                                    <div class="et-2-schedule-img absolute md:static md:-mt-[45px] bottom-0 md:before:content-none before:absolute before:top-0 before:left-[100%] before:w-full before:h-full before:bg-gradient-to-br before:from-etBlue before:to-[#0B3998] before:-z-[1]">
                                        <img src="{{asset('/')}}frontend/img/evenet-sched-3.jpg" alt="scehduled-event-cover" class="rounded-[20px] rounded-tr-none object-cover aspect-[8/9]">
                                    </div>
                                </div>
            ...
            <!-- vectors -->
            <div class="md:hidden">
                <img src="{{asset('/')}}frontend/img/features-vector-1.png" alt="vector" class="pointer-events-none absolute top-[254px] left-[93px] -z-[1]">
                <img src="{{asset('/')}}frontend/img/schedule-vector.png" alt="vector" class="pointer-events-none absolute bottom-[270px] left-[125px] -z-[1]">
                <img src="{{asset('/')}}frontend/img/features-vector-2.png" alt="vector" class="pointer-events-none absolute top-[184px] right-[151px] -z-[1]">
                <img src="{{asset('/')}}frontend/img/features-vector-3.png" alt="vector" class="pointer-events-none absolute bottom-[455px] right-[93px] -z-[1]">
            </div>
        </section>
                ...
                <div class="grid grid-cols-3 md:grid-cols-3 sm:grid-cols-2 xxs:grid-cols-1 justify-center gap-[30px] lg:gap-[20px]">
                    ...
                    <div class="et-member group">
                        <div class="et-member__img rounded-[16px] overflow-hidden">
                            <img src="{{asset('/')}}frontend/img/team-member-1.jpg" alt="Team Member Image" class="w-full duration-[400ms] group-hover:scale-110">
                        </div>
                    ...
                    <div class="et-member group">
                        <div class="et-member__img rounded-[16px] overflow-hidden">
                            <img src="{{asset('/')}}frontend/img/team-member-2.jpg" alt="Team Member Image" class="w-full duration-[400ms] group-hover:scale-110">
                        </div>
                    ...
                    <div class="et-member group">
                        <div class="et-member__img rounded-[16px] overflow-hidden">
                            <img src="{{asset('/')}}frontend/img/team-member-3.jpg" alt="Team Member Image" class="w-full duration-[400ms] group-hover:scale-110">
                        </div>
        ...
        <div class="container mx-auto max-w-[calc(100%-37.1vw)] xxxl:max-w-[calc(100%-350px)] xl:max-w-[calc(100%-170px)] px-[12px] lg:max-w-full rev-slide-up relative z-[2]">
            <div class="bg-etBlue relative z-[1] p-[60px] xxl:p-[40px] xs:px-[20px] rounded-[20px] overflow-hidden -mb-[114px] shadow-[0_4px_50px_rgba(18,96,254,0.2)] after:absolute after:inset-0 after:-z-[1] after:bg-[url(../assets/img/et-counter-bg.jpg)] after:bg-cover after:bg-no-repeat after:mix-blend-screen">
                    ...
                    <div class="flex gap-x-[62px] sm:flex-col gap-y-[15px]">
                        <div class="flex items-center sm:justify-center gap-[15px] xxs:gap-[10px] shrink-0 ">
                            ...
                            <div class="text-white">
                                ...
                                <h5 class="font-medium text-[22px] xxs:text-[22px]"><a href="tel:88012365499">+88 0123 654 99</a></h5>
                            </div>
                        </div>
                ...
                <!-- vectors -->
                <div>
                    <img src="{{asset('/')}}frontend/img/cta-vector-1.png" alt="vector" class="pointer-events-none absolute top-0 left-0">
                    <img src="{{asset('/')}}frontend/img/cta-vector-2.png" alt="vector" class="pointer-events-none absolute bottom-0 right-0">
                </div>
            </div>
        </div>
        <!-- CTA SECTION END -->
        ...
        <div class="bg-[#00339A] relative z-[1] after:absolute after:inset-0 after:bg-[url(../assets/img/features-bg.jpg)] after:bg-no-repeat after:bg-cover after:-z-[2] after:pointer-events-none after:opacity-50 pb-[130px] xl:pb-[80px] md:pb-[60px] pt-[244px] xl:pt-[194px] md:pt-[174px]">
                ...
                <div class="grid grid-cols-4 md:grid-cols-3 sm:grid-cols-2 xxs:grid-cols-1 gap-[30px] lg:gap-[20px] items-start">
                    ...
                    <div class="et-2-feature-card rounded-[30px] overflow-hidden group relative">
                        <div class="et-2-feature-card-txt bg-white p-[30px]">
                            ...
                            <div class="w-[102px] aspect-square border-[10px] bg-etBlue border-[#EDF3FE] rounded-full flex items-center justify-center mb-[20px]">
                                <img src="{{asset('/')}}frontend/img/feature-1.png" alt="Feature icon" class="transition duration-[0.4s] group-hover:-scale-x-100">
                            </div>
                    ...
                    <div class="et-2-feature-card rounded-[30px] overflow-hidden group relative">
                        <div class="et-2-feature-card-txt bg-white p-[30px]">
                            <!-- icon -->
                            <div class="w-[102px] aspect-square border-[10px] bg-etBlue border-[#EDF3FE] rounded-full flex items-center justify-center mb-[20px]">
                                <img src="{{asset('/')}}frontend/img/feature-2.png" alt="Feature icon" class="transition duration-[0.4s] group-hover:-scale-x-100">
                            </div>
                    ...
                    <div class="et-2-feature-card rounded-[30px] overflow-hidden group relative">
                        <div class="et-2-feature-card-txt bg-white p-[30px]">
                            <!-- icon -->
                            <div class="w-[102px] aspect-square border-[10px] bg-etBlue border-[#EDF3FE] rounded-full flex items-center justify-center mb-[20px]">
                                <img src="{{asset('/')}}frontend/img/feature-3.png" alt="Feature icon" class="transition duration-[0.4s] group-hover:-scale-x-100">
                            </div>
                    ...
                    <div class="et-2-feature-card rounded-[30px] overflow-hidden group relative">
                        <div class="et-2-feature-card-txt bg-white p-[30px]">
                            <!-- icon -->
                            <div class="w-[102px] aspect-square border-[10px] bg-etBlue border-[#EDF3FE] rounded-full flex items-center justify-center mb-[20px]">
                                <img src="{{asset('/')}}frontend/img/feature-4.png" alt="Feature icon" class="transition duration-[0.4s] group-hover:-scale-x-100">
                            </div>
            ...
            <!-- vectors -->
            <div>
                <img src="{{asset('/')}}frontend/img/stats-vector-2.png" alt="vector" class="pointer-events-none absolute top-[85px] right-[67px] -z-[1] opacity-10">
            </div>
        </div>
        ...
        <section class="py-[130px] lg:py-[80px] md:py-[60px] relative z-[1]">
            <div class="container mx-auto max-w-[calc(100%-37.1vw)] xxxl:max-w-[calc(100%-350px)] xl:max-w-[calc(100%-170px)] px-[12px] lg:max-w-full">
                ...
                <!-- pricing -->
                <div class="grid grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-[30px] md:gap-[20px]">
                    <!-- single pricing -->
                    <div class="p-[40px] xxl:p-[30px] xl:p-[25px] border border-[rgb(229,229,229)] rounded-[16px] overflow-hidden relative z-[1] rev-slide-up">
                        <div class="bg-etBlue py-[10px] pr-[16px] pl-[37px] text-white absolute -z-[1] right-0 before:absolute before:top-0 before:right-[calc(100%-12px)] before:h-full before:aspect-square before:bg-white before:rotate-[45deg] before:pointer-events-none before:-z-[1]">
                        ...
                        <div class="border-b border-[#DBDBDB]">
                            ...
                            <span class="block text-[18px] text-etGray mb-[25px]">One Day</span>
                    ...
                    <!-- single pricing -->
                    <div class="p-[40px] xxl:p-[30px] xl:p-[25px] bg-etBlue rounded-[16px] shadow-[0_4px_60px_rgba(18,96,254,0.12)] overflow-hidden relative z-[1] rev-slide-up">
                        <div class="bg-[#FE8F0E] py-[10px] pr-[16px] pl-[37px] text-white absolute -z-[1] right-0 before:absolute before:top-0 before:right-[calc(100%-12px)] before:h-full before:aspect-square before:bg-etBlue before:rotate-[45deg] before:pointer-events-none before:-z-[1]">
                            <h5 class="font-normal text-[15px]">Most Popular</h5>
                        </div>

                        <!-- price -->
                        <div class="border-b border-[#DBDBDB]/20 text-white">
                            <h4 class="font-semibold text-[40px] md:text-[35px] leading-[0.8] mb-[9px]">$39.00</h4>
                            <span class="block text-[18px] mb-[25px]">One Day</span>
                            <p class="text-[16px] mb-[23px]">Lnteger sapien nec sapien sollicitudin ultrices Cras tempor id lorem et</p>
                        </div>

                        <!-- features -->
                        <ul class="text-[16px] font-light text-white pt-[23px] mb-[31px] space-y-[17px] *:relative *:pl-[25px] *:before:absolute *:before:bg-[url(../assets/img/checkmark-white.svg)] *:before:w-[14px] *:before:aspect-square *:before:left-0 *:before:top-[4px]">
                            <li>Get everything a Conference pass</li>
                            <li>Enjoy 2 days of inspiring talks</li>
                            <li>Breakout sessions exploring</li>
                            <li>Challenging topics, great food.</li>
                        ...
                        <span class="font-light text-[15px] text-white block mb-[13px]">Up to 10 users + 1.99 per user</span>

                        <a href="#" class="flex items-center gap-[10px] justify-center rounded-full border border-white h-[55px] px-[15px] font-semibold text-[16px] text-white hover:bg-white hover:text-etBlue">
                            <span>Choose Plan</span>
                            <span class="icon"> <i class="fa-solid fa-arrow-right-long"></i> </span>
                        </a>
                    </div>
        ...
        <section class="grid grid-cols-4 lg:grid-cols-3 sm:grid-cols-2">
            ...
            <!-- single gallery item -->
            <div class="relative z-[1] group before:absolute before:inset-0 before:bg-etBlack/70 before:z-[0] before:opacity-0 before:transition before:duration-[400ms] hover:before:opacity-100">
                <img src="{{asset('/')}}frontend/img/gallery-img-5.jpg" alt="gallery image">
                <a href="{{asset('/')}}frontend/img/gallery-img-5.jpg" data-fslightbox="gallery" class="inline-flex items-center justify-center w-[64px] aspect-square rounded-full bg-white text-[25px] absolute top-[50%] left-[50%] -translate-x-[50%] -translate-y-[50%] opacity-0 group-hover:opacity-100 hover:text-etBlue">
                    <i class="fa-plus fa-regular"></i>
                </a>
            </div>
            ...
            <!-- single gallery item -->
            <div class="relative z-[1] group before:absolute before:inset-0 before:bg-etBlack/70 before:z-[0] before:opacity-0 before:transition before:duration-[400ms] hover:before:opacity-100">
                <img src="{{asset('/')}}frontend/img/gallery-img-6.jpg" alt="gallery image">
                <a href="{{asset('/')}}frontend/img/gallery-img-6.jpg" data-fslightbox="gallery" class="inline-flex items-center justify-center w-[64px] aspect-square rounded-full bg-white text-[25px] absolute top-[50%] left-[50%] -translate-x-[50%] -translate-y-[50%] opacity-0 group-hover:opacity-100 hover:text-etBlue">
                    <i class="fa-plus fa-regular"></i>
                </a>
            </div>
            ...
            <!-- single gallery item -->
            <div class="relative z-[1] group before:absolute before:inset-0 before:bg-etBlack/70 before:z-[0] before:opacity-0 before:transition before:duration-[400ms] hover:before:opacity-100">
                <img src="{{asset('/')}}frontend/img/gallery-img-7.jpg" alt="gallery image">
                <a href="{{asset('/')}}frontend/img/gallery-img-7.jpg" data-fslightbox="gallery" class="inline-flex items-center justify-center w-[64px] aspect-square rounded-full bg-white text-[25px] absolute top-[50%] left-[50%] -translate-x-[50%] -translate-y-[50%] opacity-0 group-hover:opacity-100 hover:text-etBlue">
                    <i class="fa-plus fa-regular"></i>
                </a>
            </div>
        </section>
                    ...
                    <div class="swiper-wrapper">
                            ...
                            <div class="et-testimony relative p-[40px] lg:p-[30px] md:p-[20px] border border-[#D4DCED] rounded-[16px] mt-[60px]">
                                ...
                                <div class="et-testimony__heading flex items-end justify-center mb-[17px] lg:mb-[12px] -mt-[100px] md:-mt-[80px]">
                                    <div class="et-testimony__img rounded-full overflow-hidden border border-etBlue p-[7px] w-max max-w-full">
                                        <img src="{{asset('/')}}frontend/img/reviewer-1.png" alt="reviewer image" class="w-[100px] sm:w-[80px] h-[100px] sm:h-[80px] rounded-full">
                                    </div>
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="et-testimony relative p-[40px] lg:p-[30px] md:p-[20px] border border-[#D4DCED] rounded-[16px] mt-[60px]">
                                ...
                                <div class="et-testimony__heading flex items-end justify-center mb-[17px] lg:mb-[12px] -mt-[100px] md:-mt-[80px]">
                                    <div class="et-testimony__img rounded-full overflow-hidden border border-etBlue p-[7px] w-max max-w-full">
                                        <img src="{{asset('/')}}frontend/img/reviewer-2.png" alt="reviewer image" class="w-[100px] sm:w-[80px] h-[100px] sm:h-[80px] rounded-full">
                                    </div>
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="et-testimony relative p-[40px] lg:p-[30px] md:p-[20px] border border-[#D4DCED] rounded-[16px] mt-[60px]">
                                ...
                                <div class="et-testimony__heading flex items-end justify-center mb-[17px] lg:mb-[12px] -mt-[100px] md:-mt-[80px]">
                                    <div class="et-testimony__img rounded-full overflow-hidden border border-etBlue p-[7px] w-max max-w-full">
                                        <img src="{{asset('/')}}frontend/img/reviewer-3.png" alt="reviewer image" class="w-[100px] sm:w-[80px] h-[100px] sm:h-[80px] rounded-full">
                                    </div>
                                </div>
        ...
        <section class="et-2-sponsors bg-[#00239F] py-[130px] lg:py-[80px] md:py-[60px] relative z-[1] before:absolute before:inset-0 before:bg-[url('{{asset('/')}}frontend/img/sponsors-bg.jpg')] before:bg-cover before:bg-center before:bg-no-repeat before:-z-[1] before:opacity-30">
            <div class="container mx-auto max-w-[calc(100%-37.1vw)] xxxl:max-w-[calc(100%-350px)] xl:max-w-[calc(100%-170px)] px-[12px] lg:max-w-full">
                <!-- heading -->
                <div class="text-center mb-[52px] xl:mb-[42px] md:mb-[32px]">
                ...
                <div class="flex flex-wrap gap-y-[60px] lg:gap-y-[40px] gap-x-[76px] xxl:gap-x-[56px] xl:gap-x-[46px] lg:gap-x-[36px] mb-[60px]">
                    <div><img src="{{asset('/')}}frontend/img/sponsor-1-light.png" alt="sponsor logo" class="w-[80%] mx-auto"></div>
                    <div><img src="{{asset('/')}}frontend/img/sponsor-2-light.png" alt="sponsor logo" class="w-[80%] mx-auto"></div>
                    <div><img src="{{asset('/')}}frontend/img/sponsor-3-light.png" alt="sponsor logo" class="w-[80%] mx-auto"></div>
                    <div><img src="{{asset('/')}}frontend/img/sponsor-4-light.png" alt="sponsor logo" class="w-[80%] mx-auto"></div>
                    <div><img src="{{asset('/')}}frontend/img/sponsor-5-light.png" alt="sponsor logo" class="w-[80%] mx-auto"></div>
                    <div><img src="{{asset('/')}}frontend/img/sponsor-6-light.png" alt="sponsor logo" class="w-[80%] mx-auto"></div>
                    <div><img src="{{asset('/')}}frontend/img/sponsor-7-light.png" alt="sponsor logo" class="w-[80%] mx-auto"></div>
                    <div><img src="{{asset('/')}}frontend/img/sponsor-8-light.png" alt="sponsor logo" class="w-[80%] mx-auto"></div>
                    <div><img src="{{asset('/')}}frontend/img/sponsor-9-light.png" alt="sponsor logo" class="w-[80%] mx-auto"></div>
                    <div><img src="{{asset('/')}}frontend/img/sponsor-2-light.png" alt="sponsor logo" class="w-[80%] mx-auto"></div>
                    <div><img src="{{asset('/')}}frontend/img/sponsor-10-light.png" alt="sponsor logo" class="w-[80%] mx-auto"></div>
                </div>
                ...
                <div class="et-2-blogs-slider swiper p-[30px] -m-[30px]">
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide group">
                            <div class="et-blog bg-white relative group-[.swiper-slide-visible]:shadow-[0_4px_25px_rgba(0,0,0,0.06)]">
                                <div class="et-blog__img relative overflow-hidden z-[1]">
                                    <img src="{{asset('/')}}frontend/img/blog-1.jpg" alt="category-icon" class="w-full aspect-[37/24] object-cover transition duration-[400ms] group-hover:scale-105">
                                </div>
                                ...
                                <div class="et-blog__txt bottom-0 z-[3] p-[30px] lg:p-[20px]">
                                    <div class="et-blog__infos flex gap-x-[30px] mb-[13px]">
                                        ...
                                        <div class="et-blog-info flex items-center gap-x-[10px]">
                                            <span class="icon"><img src="{{asset('/')}}frontend/img/calender-blue.svg" alt="icon"></span>
                                            <span class="text font-normal text-[14px] text-etGray">Feb 10, 2024</span>
                                        </div>

                                        <!-- single info -->
                                        <div class="et-blog-info flex items-center gap-x-[10px]">
                                            <span class="icon"><img src="{{asset('/')}}frontend/img/user-blue.svg" alt="icon"></span>
                        ...
                        <div class="swiper-slide group">
                            <div class="et-blog bg-white relative group-[.swiper-slide-visible]:shadow-[0_4px_25px_rgba(0,0,0,0.06)]">
                                <div class="et-blog__img relative overflow-hidden z-[1]">
                                    <img src="{{asset('/')}}frontend/img/blog-2.jpg" alt="category-icon" class="w-full aspect-[37/24] object-cover transition duration-[400ms] group-hover:scale-105">
                                </div>
                        ...
                        <div class="swiper-slide group">
                            <div class="et-blog bg-white relative group-[.swiper-slide-visible]:shadow-[0_4px_25px_rgba(0,0,0,0.06)]">
                                <div class="et-blog__img relative overflow-hidden z-[1]">
                                    <img src="{{asset('/')}}frontend/img/blog-3.jpg" alt="category-icon" class="w-full aspect-[37/24] object-cover transition duration-[400ms] group-hover:scale-105">
                                </div>
