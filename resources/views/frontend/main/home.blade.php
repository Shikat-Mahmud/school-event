...
@section('content')
        ...
        <section class="et-2-banner relative bg-etBlue max-w-[1920px]" style="background-image: url('{{asset('/')}}frontend/img/banner-2-bg-1.jpg');">
                    ...
                    <div class="mx-[15.5em] xxxl:mx-[10em] xxl:mx-[40px] xs:mx-[12px] mb-[132px] xl:mb-[112px] lg:mb-[82px]">
                        <div class="flex md:flex-col items-center justify-between gap-x-[30px] gap-y-[30px] md:grid-cols-1">
                            <div class="left relative z-[20] w-[80%] md:w-full">
                                ...
                                <h1
                                    class="text-[clamp(42px,6.25vw,12rem)] font-semibold leading-[1.1] mb-[36px] md:mb-[36px] anim-text"> Ex Students <span class="italic font-normal">Child Care Academy</span></h1>
                                ...
                                <div class="et-banner-btns flex flex-wrap items-center gap-[20px]">
                                    ...
                                    <a href="#"
                                        class="et-btn bg-white inline-flex items-center justify-center gap-x-[13px] h-[45px] px-[15px] text-etBlue font-normal text-[17px] rounded-full">Register Now</a>
        ...
        <div class="bg-[#00339A] relative z-[1] after:absolute after:inset-0 after:bg-no-repeat after:bg-cover after:-z-[2] after:pointer-events-none after:opacity-50 pb-[130px] xl:pb-[80px] md:pb-[60px] pt-[244px] xl:pt-[194px] md:pt-[174px]"  style="background-image: url('{{asset('/')}}frontend/img/features-bg.jpg');">
